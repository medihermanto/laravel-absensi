        ...
        <div class="card-body">
            <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                @enderror" name="name" id="basic-default-fullname" value="{{ old('name', $user->name) }}" placeholder="masukkan nama user">
                @error('name')
              ...
              <div class="mb-3">
                ...
                @enderror" name="email" value="{{ old('email', $user->email) }}" id="basic-default-email" placeholder="email@example.com">
                @error('email')
                <div class="alert alert-danger alert-dismissible mt-1" role="alert">
                    {{ $message }}
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
